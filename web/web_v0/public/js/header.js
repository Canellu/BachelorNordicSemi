...
<header class="z-50 fixed top-0 bg-dark text-light h-16 w-full">
  <div class="container flex justify-between m-auto h-full items-center px-10">
    ...
    <a href="home.html" class="headerBtn">
        <h4>Devices</h4>
      </a>
      ...
      <a href="index.html" id="logout" class="headerBtn" onclick="logOut()">
        <h4>Logout</h4>
      </a>
    </div>
  </div>
