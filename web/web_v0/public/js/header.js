...
<header class="z-50 fixed top-0 bg-dark text-light h-14 sm:h-16 w-full">
  <div
    class="container flex justify-between m-auto h-full items-center px-4"
  >
    <!--  OASYS logo -->
    <a href="home.html" class="px-6 py-2">
      <h4 class="text-2xl font-bold">OASYS</h4>
    </a>

    <!-- Mobile Links Icons -->
    <div class="sm:hidden flex items-center space-x-4 font-semibold">
      <a
        href="home.html"
