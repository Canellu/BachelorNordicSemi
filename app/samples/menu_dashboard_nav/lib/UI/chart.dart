...
class Chart extends StatelessWidget {
  ...
  Chart({Key key, this.dataType, this.dataset}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      child: TestChartPage(dataForChart: dataForChart,dataType: dataType,),
    );
  }
/*
...
class TestChartPage extends StatefulWidget {
  ...
  final String dataType;
  const TestChartPage({Key key, this.dataForChart, this.dataType}) : super(key: key);

  @override
  _TestChartPageState createState() => new _TestChartPageState();
